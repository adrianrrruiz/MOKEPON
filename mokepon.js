                    ...
                    .then(function ({ enemigos }) {
                        ...
                        mokeponesEnemigos = enemigos.map(function (enemigo){
                            ...
                            if (mokeponNombre === "Hipodoge") {
                                mokeponEnemigo = new Mokepon('Hipodoge','./assets/hipodogue.png', 5, './assets/hipodogue2.png', enemigo.id)
                            } else if (mokeponNombre === "Capipepo") {
                                mokeponEnemigo = new Mokepon('Capipepo','./assets/capipepo.png', 5, './assets/capipepo2.png', enemigo.id)
